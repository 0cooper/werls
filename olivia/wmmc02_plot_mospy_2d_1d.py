...
# select object
notes = Table.read('../wmmc02/cooper_notes_wmmc02.csv',format='csv')
idx = 13
...
hdu2 = fits.open('../wmmc02/mospy_products/COMBINED/wmmc02_COMBINED_'+obj_name+'_eps.fits') # 2D spectrum
hdu1 = fits.open('../wmmc02/mospy_products/wmmc02_2022.02.11/wmmc02_Y_'+obj_name+'_1D_00.fits') # 1D spectrum
...
fig.savefig('plots/wmmc02/'+obj_name+'_manual_boxcar_1D_2D_lines.png',dpi=500)
